...
class Withdrawal(TimestampMixin, Base):
    ...
    gateway_contact_id: Mapped[str | None] = mapped_column(String(255))
    gateway_fund_account_id: Mapped[str | None] = mapped_column(String(255))
    gateway_payout_id: Mapped[str | None] = mapped_column(String(255), unique=True)
